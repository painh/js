...
var SceneIngame = function()
{
	...
	this.Render_StarBreak = function()
	{
		...
		var leftTime = STAR_BREAK_TIME - (Renderer.currentTime - this.stateStartTime);
		Renderer.Text(0, 20, "Star Cnt " + leftTime );
		Renderer.Text(0, 40, "time left : " + this.markedStarCnt );
